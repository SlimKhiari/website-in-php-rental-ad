...
<html>
    <head>
        <meta charset="utf-8"/>
        <title> Salammbo Beach - Welcome </title>
    ...
    <body>
        <div>
            <nav class="navbar navbar-expand-lg navbar navbar-light" style="background-color:#92D0E9;">
                <a href="index.php" class="navbar-brand">Salammbo Beach</a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse9">
                    <div class="navbar-nav">
                        <a href="galleries.php" class="nav-item nav-link">Galleries</a>
                        <a href="rent.php" class="nav-item nav-link">Rent a house</a>
                        <a href="opinion.php" class="nav-item nav-link">Share your opinion</a>
                    </div>
                </div>
            </nav>
        </div>

       <center><h3 class="ml15">
        <span class="word" style="color:#307C91">Welcome</span>
        <span class="word" style="color:#B6DCE9">to</span>
        <span class="word" style="color:#1D5171">Salammbo</span>
        <span class="word" style="color: #B6DCE9">Beach</span>
        </h3>
      
        <script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/2.0.2/anime.min.js"></script></center>   
        <script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/2.0.2/anime.min.js"></script>
        <script src="salamboBeach.js"></script>

        <div class="card bg-dark text-white" >
            <img class="card-img" src="photoUn.jpg" alt="Card image">
            <div class="card-img-overlay"> 
                <h1 style="color:#1D5171; font-family: 'Encode Sans SC', sans-serif; font-size:15px;">
                    Neighborhood at the exit of Carthage, Salammbo was quoted in the novels of Flaubert.</br>
                    Today more or less luxurious and popular villas occupy this district.</br>
                    Young Tunisians love to play football on the small beach of Salambô.
                </h1>
       ...
       <center>
        <hr>
        <h1 style="font-family: 'Pacifico', cursive; color:#1D5171;">  Places not to be missed ! </h1>
        </center> 
        <br>

        <div class="card-group">
            <div class="card">
              <img class="card-img-top" src="parcSalammbo.jfif" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">Salammbo Park</h5>
                <p class="card-text">Small park,next to Salammbo Beach, well laid out and very pleasant.</br>
                    Perfect for a walk and a breath of fresh air.</p>
              </div>
            </div>
            <div class="card">
                <img class="card-img-top" src="punicart.jpg" alt="Card image cap">
                <div class="card-body">
                  <h5 class="card-title">Punic'Art</h5>
                  <p class="card-text">
                    A wonderful restaurant near salammbo beach and in the salammbo park. Ideal breakfast by the sea, with friends, as a couple or as a family. You will surely enjoy yourself and change the air a little.</p>
                </div>
              </div>
              <div class="card">
                <img class="card-img-top" src="portPunique.jpg" alt="Card image cap">
                <div class="card-body">
                  <h5 class="card-title">Punic port of Carthage</h5>
                  <p class="card-text">
                    These two magnificent places are not far from the Punic port of Carthage. Do not hesitate to visit it ^^.</p>
                </div>
              </div>
            </div>
